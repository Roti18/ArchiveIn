	...
	<div class="flex flex-col">
		{#each $currentItems as item}
			<button
				...
				class="group grid grid-cols-[1fr_40px] gap-12 border-b border-white/8 py-8 transition-all duration-450 ease-in-out hover:translate-x-1.5 hover:bg-gray-950 max-md:gap-4"
			>
				<div class="text-left">
